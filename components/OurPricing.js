...
const OurPricing = () => {
  ...
  useEffect(() => {
    ...
    async function updatePriceToPage(
      ...
      priceAmount.innerHTML = `$${priceData}<span className="suffix">/month onwards</span>`;
      dataLayer.push({
            ...
            <div className="max-width-xlarge align-center">
              ...
              >
                <div className="tabs_menu-service w-tab-menu">
                  ...
                  <a
                    data-w-tab="Tab 2 Form"
                    className="tabs1_link-service _3rd w-inline-block w-tab-link w--current"
                  >
                    <div>
                      Show Pricing by App
                      <br />
                ...
                <div className="tabs_content w-tab-content">
                  ...
                  <div
                    data-w-tab="Tab 2 Form"
                    className="tabs_tab-pane w-tab-pane w--tab-active"
                  >
                    <div className="tabs_content-wrapper-service">
                      <div className="max-width-full">
                        <div
