...
const OurPricing = () => {
  ...
  return (
    <>
      <div id="our-pricing" class="form-capture-section">
              ...
              >
                <div class="tabs_menu-service w-tab-menu">
                  <Link
                    ...
                    class="tabs1_link-service first w-inline-block w-tab-link w--current"
                  >
                    <div>
                      Pricing Guide
                      <br />
                            ...
                            <div class="app-search-box-holder">
                              <div class="search-box_holder flex-custom width">
                                <div class="code-left">
                                  ...
                                  <div class="style-new w-embed"></div>
                                </div>
                              </div>
                              <div
          ...
          <div class="about-this-service-wrapper">
            <div class="split-content about-this-service-left">
              ...
              >
                ...
                So, if the cost reduction is <span class="text-bold">x</span>,
                then you pay a fee that is much lower than x.
                <br />
              </p>
              <div
            ...
            <div class="images-wrapper about-this-service">
              <div class="image-wrapper about-this-service-1 new">
                <img
              ...
              <div class="image-wrapper about-this-service-2 new">
                <img
